...
function getPositionEnd( element, viewFactor = 0, wHeight = window.innerHeight ){
	...
	var positionBottom = offset + elementHeight - (elementHeight * viewFactor);
...
function elementInViewport(el, pageXOffset = window.pageXOffset, pageYOffset = window.pageYOffset, innerWidth = window.innerWidth, innerHeight = window.innerHeight) {
